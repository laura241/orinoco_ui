...
function AddToBasket({id}) {
  ...
  function handleClick() {
    ...
    // Toast d'ajout au panier
      ToastsStore.info("Votre produit a été ajouté au panier!");
  }

  return (
        <>
            <button  className ="button-primary" onClick={handleClick}>Ajouter au panier></button><ToastsContainer store={ToastsStore}/>
        </>)
}
